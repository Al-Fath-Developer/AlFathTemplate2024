...
function header(row, nama_folder){
  ...
  cell_pojok_kiri_atas.setBackground("black").setFontColor('white').setValue("Rekap Folder '" + nama_folder + "' Start From ± " +  waktu).setFontSize(13).setHorizontalAlignment('center').setFontWeight('bold')
